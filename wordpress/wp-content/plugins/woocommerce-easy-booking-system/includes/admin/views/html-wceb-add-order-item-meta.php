    ...
    <table class="meta" cellspacing="0">
        ...
        <tbody class="meta_items">
            ...
            <tr data-meta_id="<?php echo esc_attr( $start_display_meta_id ); ?>">
                ...
                <input type="hidden" class="start_display" name="meta_value[<?php echo esc_attr( $item_id ); ?>][<?php echo esc_attr( $start_display_meta_id ); ?>]" value="">
            ...
            <?php if ( wceb_get_product_booking_dates( $_product ) === 'two' ) : ?>
                ...
                <tr data-meta_id="<?php echo esc_attr( $end_display_meta_id ); ?>">
                    ...
                    <input type="hidden" class="end_display" name="meta_value[<?php echo esc_attr( $item_id ); ?>][<?php echo esc_attr( $end_display_meta_id ); ?>]" value="">
